...
//
// Denemede o menü hiç çizilmiyor (hesaba bağlı düğmeleri var), yani telefondan
// gelen ziyaretçinin kılavuzu elle açacak hiçbir yolu kalmıyordu: bir kez
// kapattıysa araçtan çıkıp tekrar girene kadar geri getiremiyordu. Denemede
// düğme dar ekranda da görünüyor.
export default function ToolGuideButton() {
  ...
  return (
    <button
      ...
      className={clsx(
        'items-center gap-2 rounded-xl border px-3 py-2 text-sm font-medium shadow-sm backdrop-blur-md transition-colors',
        denemeKipindeMi() ? 'flex' : 'hidden sm:flex',
        guideOpen
