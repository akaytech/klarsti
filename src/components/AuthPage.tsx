...
export default function AuthPage({ mode }: { mode: 'login' | 'register' }) {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-white dark:bg-slate-900 overflow-y-auto">
      ...
      <div className="hidden md:flex flex-col justify-between w-2/3 bg-slate-50 dark:bg-slate-800 p-12 border-r border-slate-200 dark:border-slate-700 relative">
        ...
        <div className="mt-8 rounded-2xl bg-white dark:bg-slate-900 shadow-sm border border-slate-200 dark:border-slate-700 p-6 flex gap-6">
           <div className="flex-1 flex items-center gap-4 border-e border-slate-200 dark:border-slate-700">
      ...
      {/* Right Side (1/3) - Form */}
      <div className="flex w-full md:w-1/3 flex-col justify-center p-8 lg:p-12 relative">
        <button 
          onClick={() => navigate('/')}
        ...
        <form onSubmit={handleSubmit} className="space-y-4 max-w-sm mx-auto md:mx-0 md:max-w-none w-full">
          <div>
            <label htmlFor="auth-email-input" className="mb-1 block text-sm font-semibold text-slate-700 dark:text-slate-300">{t('email')}</label>
            <input
              id="auth-email-input"
              ref={emailInputRef}
              type="email"
          ...
          <div>
            <label htmlFor="auth-password-input" className="mb-1 block text-sm font-semibold text-slate-700 dark:text-slate-300">{t('password')}</label>
            <div className="relative">
              ...
              <button
                ...
                className="absolute end-3 top-1/2 -translate-y-1/2 p-2 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300"
              >
        ...
        <div className="my-6 flex items-center gap-3 max-w-sm mx-auto md:mx-0 md:max-w-none w-full">
        ...
        <button
          ...
          disabled={isSubmitting}
          className="flex w-full max-w-sm mx-auto md:mx-0 md:max-w-none items-center justify-center gap-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-3 font-bold text-slate-700 dark:text-slate-200 transition-colors hover:bg-slate-50 dark:hover:bg-slate-700 disabled:opacity-70"
        >
          {isSubmitting ? (
