...
export default function SharePanel({ onClose, projectId: istenenProje, tool, workId }: Props) {
  ...
  return (
    <MenuPortal>
    <div
      className="perde-gir fixed inset-0 z-[120] flex items-center justify-center bg-slate-900/50 p-4 backdrop-blur-sm"
      onClick={onClose}
    >
      <div
        role="dialog"
        ...
        className="kutu-gir w-full max-w-md overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl dark:border-slate-800 dark:bg-slate-900"
